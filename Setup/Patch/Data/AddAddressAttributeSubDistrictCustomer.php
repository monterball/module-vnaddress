...
class AddAddressAttributeSubDistrictCustomer implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(AttributeProvider::ENTITY, 'sub_district', [
            ...
            'label' => 'Ward',
            'input' => 'select',
            'source' => 'Eloab\VNAddress\Model\Customer\Address\Attribute\Source\SubDistrict',
            'required' => false,
            'visible' => true,
            'position' => 100,
            'system' => false,
